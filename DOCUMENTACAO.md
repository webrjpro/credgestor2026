...
Artefatos oficiais da versao 6.0.3:
...
- `npm run qa`: 100/100.
- Testes backend: pass.
- Instalador Inno gerado com nome `CredGestor-InnoSetup-6.0.3.exe`.
- Instalador NSIS/update gerado com nome `CredGestor-Setup-6.0.3.exe`.
